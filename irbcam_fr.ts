...
Placeholder for when no user frame number is entered</extracomment>
    ...
    <message>
        ...
        <extracomment>Warns the user that the selected robot must be activated before exporting robot code</extracomment>
        <translation type="unfinished">L'abonnement actif ne permet pas d'exporter le code robot pour le contrôleur KUKA VKRC4. Vous pouvez nous contacter pour mettre à niveau votre abonnement %1ici%2</translation>
    </message>
    <message>
